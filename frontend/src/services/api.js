...
export const eventService = {
  ...
  rejectSubmission: (id, reason) => API.put(`/api/events/submissions/${id}/reject`, { reason }).then(r => r.data),
  deleteSubmission: (id) => API.delete(`/api/events/submissions/${id}`).then(r => r.data),
};
