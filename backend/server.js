...
// Force IPv4 DNS — Render free tier blocks IPv6 outbound connections
...
if (fs.existsSync(distDir)) {
  // Serve hashed assets with 1-year cache, HTML with no-cache
  ...
  app.use((req, res) => res.status(404).json({ message: 'Route not found (dist not built yet)' }));
}
